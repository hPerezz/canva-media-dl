...
## Features
- Lists images found on the current Canva tab
...
3. Click any thumbnail to download the file.

Optional:
- Right-click an image on Canva and select **Download image**.
